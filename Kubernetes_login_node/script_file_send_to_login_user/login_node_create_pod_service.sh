...
while true; do
    ...
    echo "1) 141GB (nvidia.com/gpu)"
    echo "2) 71GB (nvidia.com/mig-3g.71gb)"
    echo "3) 35GB (nvidia.com/mig-2g.35gb)"
    echo "4) 18GB (nvidia.com/mig-1g.18gb)"
    read -p "Enter your choice (1/2/3/4): " GPU_CHOICE
    case $GPU_CHOICE in
        1) GPU_RESOURCE_KEY="nvidia.com/gpu"; break ;;
        2) GPU_RESOURCE_KEY="nvidia.com/mig-3g.71gb"; break ;;
        3) GPU_RESOURCE_KEY="nvidia.com/mig-2g.35gb"; break ;;
        4) GPU_RESOURCE_KEY="nvidia.com/mig-1g.18gb"; break ;;
