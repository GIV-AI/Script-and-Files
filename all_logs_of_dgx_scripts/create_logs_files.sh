...
/home/jain-dgx/Scripts_and_Files/all_logs_of_dgx_scripts/filter_docker_containers_using_gpu.sh > "$MAIN_PATH/all_running_containers/$DATE.txt"
/home/jain-dgx/Scripts_and_Files/all_logs_of_dgx_scripts/filter_rootless_docker_containers_using_gpu.sh > "$MAIN_PATH/all_rootless_containers/$DATE.txt"

sleep 300
# Call the next script
/home/jain-dgx/Scripts_and_Files/all_logs_of_dgx_scripts/dgx_logs_summary.sh
